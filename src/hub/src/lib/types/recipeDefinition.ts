// Shape mirrors docs/todos/supporting-docs/steps-dsl.md and examples.json's `recipe.definition`.
...
// One-level nesting only: a ChildStep can never itself be a group/if (steps-dsl.md's fixed depth rule).
