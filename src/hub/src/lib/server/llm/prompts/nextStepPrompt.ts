...
- Do not hardcode input or output values in CSS or text selectors, use refs
- If there are multiple matches to a CSS selector, add specificity in the chain or pseudo selectors like "nth-child()" or "nth-of-type()"
